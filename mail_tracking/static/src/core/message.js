...
import { FailedMessage } from "../components/failed_message/failed_message";
import { useStore } from "../components/failed_message/failed_message_storage";
...
patch(Message.prototype, {
    ...
    _markFailedMessageReviewed(id) {
        return this.messageService.orm.call("mail.message","set_need_action_done",[id])
    },
    _onRetryFailedMessage(event) {
        ...
        this.env.services.action.doAction("mail.mail_resend_message_action", {
            ...
            onClose: async () => {
                ...
                const failedMessages = await this.messageService.orm.call("mail.message","get_failed_messages",[messageID]);
